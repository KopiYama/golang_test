...
func main() {
	...
	router.GET("/users/user", userHandler.GetAll)
	router.POST("/users/user", userHandler.Create)
	router.PUT("/users/user", userHandler.Update)
	router.DELETE("/users/user/:user_id", userHandler.Delete)
